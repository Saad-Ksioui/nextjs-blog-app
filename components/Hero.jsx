...
const Hero = () => {
  return (
    <section className="w-4/5 mx-auto my-10 flex flex-col justify-center items-center font-poppins">
      ...
      <p className="text-[18px] w-2/4 text-center text-gray-500 font-poppins">Join our newsletter to stay updated on new coding techniques, the latest tech trends, and more.</p>
